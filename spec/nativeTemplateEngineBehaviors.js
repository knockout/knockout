describe('Native template engine', function() {
    ...
    it('Named template can display static content from regular DOM element', function () {
    ...
    it('Named template can fetch template from regular DOM element and data-bind on results', function () {
    ...
    it('Named template can fetch template from <script> elements and data-bind on results', function () {
    ...
    it('Named template can fetch template from <textarea> elements and data-bind on results', function () {
    ...
    it('Anonymous template can display static content', function () {
    ...
    it('Anonymous template can data-bind on results', function () {
    ...
    it('Anonymous templates can be supplied by not giving a template name', function() {
    ...
    it('Anonymous templates may be nested', function() {
    ...
    it('Data-bind syntax should expose all ancestor binding contexts as $parents, with top frame also given as $root', function() {
