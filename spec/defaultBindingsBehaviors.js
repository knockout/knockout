...
describe('Binding: If', {
    ...
    'Should not destroy the pre-existing nodes until the bound value changes': function() {
        // This is partly a matter of efficiency (not rebuilding a section of the DOM until necessary), but also
