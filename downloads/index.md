...
<div class="download-debug-panel">
    Also available: <a href='knockout-3.5.3.debug.js'>debug build</a>.
...
Simply reference the JavaScript file using a `<script>` tag somewhere on your HTML pages. For example,
    ...
    <script type='text/javascript' src='knockout-3.5.3.js'></script>
...
Knockout 3.5.3 supports [Trusted Types](https://developer.mozilla.org/en-US/docs/Web/API/Trusted_Types_API) and creates a policy named `knockout` for its internal operations. If your application uses a Content Security Policy with `require-trusted-types-for 'script'`, Knockout will work with it automatically.
...
* [v3.5.3](knockout-3.5.3.js) ([debug](knockout-3.5.3.debug.js)) --- March 24, 2026
* [v3.5.2](knockout-3.5.2.js) ([debug](knockout-3.5.2.debug.js)) (deprecated) --- March 8, 2026
