...
In some scenarios, you may need to access the event object associated with your click event. Knockout will pass the event as the first parameter to your function, as in this example:
...
Now, KO will pass the event object to your function literal, which is then available to be passed to your handler.
