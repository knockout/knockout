...
b);c>=0&&a.splice(c,1)},arrayGetDistinctValues:function(a){a=a||[];for(var b=[],c=0,d=a.length;c<d;c++)ko.utils.arrayIndexOf(b,a[c])<0&&b.push(a[c]);return b},arrayMap:function(a,b){a=a||[];for(var c=[],d=0,f=a.length;d<f;d++)c.push(b(a[d]));return c},arrayFilter:function(a,b){a=a||[];for(var c=[],d=0,f=a.length;d<f;d++)b(a[d])&&c.push(a[d]);return c},emptyDomNode:function(a){for(;a.firstChild;){ko.utils.domData.cleanNodeAndDescendants(a.firstChild);a.removeChild(a.firstChild)}},setDomNodeChildren:function(a,
b){ko.utils.emptyDomNode(a);b&&ko.utils.arrayForEach(b,function(c){a.appendChild(c)})},replaceDomNodes:function(a,b){var c=a.nodeType?[a]:a;if(c.length>0){for(var d=c[0],f=d.parentNode,g=0,h=b.length;g<h;g++)f.insertBefore(b[g],d);g=0;for(h=c.length;g<h;g++){ko.utils.domData.cleanNodeAndDescendants(c[g]);f.removeChild(c[g])}}},setOptionNodeSelectionState:function(a,b){if(navigator.userAgent.indexOf("MSIE 6")>=0)a.setAttribute("selected",b);else a.selected=b},getElementsHavingAttribute:function(a,
b){if(!a||a.nodeType!=1)return[];var c=[];a.getAttribute(b)!==null&&c.push(a);for(var d=a.getElementsByTagName("*"),f=0,g=d.length;f<g;f++)d[f].getAttribute(b)!==null&&c.push(d[f]);return c},stringTrim:function(a){return(a||"").replace(e,"")},stringTokenize:function(a,b){for(var c=[],d=(a||"").split(b),f=0,g=d.length;f<g;f++){var h=ko.utils.stringTrim(d[f]);h!==""&&c.push(h)}return c},evalWithinScope:function(a,b){if(b===undefined)return(new Function("return "+a))();with(b)return eval("("+a+")")},
domNodeIsContainedBy:function(a,b){if(b.compareDocumentPosition)return(b.compareDocumentPosition(a)&16)==16;for(;a!=null;){if(a==b)return true;a=a.parentNode}return false},domNodeIsAttachedToDocument:function(a){return ko.utils.domNodeIsContainedBy(a,document)},registerEventHandler:function(a,b,c){if(typeof jQuery!="undefined")jQuery(a).bind(b,c);else if(typeof a.addEventListener=="function")a.addEventListener(b,c,false);else if(typeof a.attachEvent!="undefined")a.attachEvent("on"+b,function(d){c.call(a,
...
d.reverse()}return f}}})();
(function(){ko.utils.setDomNodeChildrenFromArrayMapping=function(e,a,b,c){a=a||[];c=c||{};var d=ko.utils.domData.get(e,"setDomNodeChildrenFromArrayMapping_lastMappingResult")===undefined,f=ko.utils.domData.get(e,"setDomNodeChildrenFromArrayMapping_lastMappingResult")||[],g=ko.utils.arrayMap(f,function(m){return m.arrayEntry}),h=ko.utils.compareArrays(g,a);a=[];var i=0,k=[];g=[];for(var j=null,l=0,q=h.length;l<q;l++)switch(h[l].status){case "retained":var n=f[i];a.push(n);if(n.domNodes.length>0)j=
n.domNodes[n.domNodes.length-1];i++;break;case "deleted":ko.utils.arrayForEach(f[i].domNodes,function(m){k.push(m);j=m});i++;break;case "added":n=b(h[l].value)||[];a.push({arrayEntry:h[l].value,domNodes:n});for(var p=0,r=n.length;p<r;p++){var o=n[p];g.push(o);if(j==null)e.firstChild?e.insertBefore(o,e.firstChild):e.appendChild(o);else j.nextSibling?e.insertBefore(o,j.nextSibling):e.appendChild(o);j=o}break}ko.utils.arrayForEach(k,function(m){ko.utils.domData.cleanNodeAndDescendants(m)});b=false;if(!d){c.afterAdd&&
c.afterAdd(g);if(c.beforeRemove){c.beforeRemove(k);b=true}}b||ko.utils.arrayForEach(k,function(m){m.parentNode&&m.parentNode.removeChild(m)});ko.utils.domData.set(e,"setDomNodeChildrenFromArrayMapping_lastMappingResult",a)}})();
